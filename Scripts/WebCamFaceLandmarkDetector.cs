...
using FaceToFaceManager;

namespace WebCamFaceLandmarkDetector
{
	public enum FaceElement
	{
		leftEye,
		rightEye,
		nose,
	...
	public class FaceLandmarks
	{
		...
		public FaceLandmarks(List<Vector2> points)
		{
			this.points = points;
		}
	...
	public class WebCamFaceLandmarkDetector : MonoBehaviour
	{
		/// <summary>
		...
		public FaceToFaceManager.FaceToFace faceToFace;
